"""mwav2npy: read multiple wave files and append their fft to a single csv file, append also the class label (0 or 1) to it"""
...
for filename in os.listdir(directory):
    ...
    f = open('class1.csv', 'ab')
    x = np.append(avg_fftmag, classLabel)
